...
![](https://substackcdn.com/image/fetch/$s_!OFF6!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https://substack-post-media.s3.amazonaws.com/public/images/ea5a00fb-6b44-41fc-8701-7f1ab7df3c74_1572x1048.png)
...
In this scenario, the Universe is characterisable as a relativistic2 fluid. In addition, every component interacts with every other, and the fluid is in thermal equilibrium (there is not any heat flow).
![](https://substackcdn.com/image/fetch/$s_!6MhY!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https://substack-post-media.s3.amazonaws.com/public/images/881c508a-07bc-4f7a-8996-ed7c6f254721_2372x1200.jpeg)
...
When the rate of ionization has fallen, the photons have nothing to interact with and don’t scatter with the matter, starting to “ free stream 4” into the Universe as it expands.
![](https://substackcdn.com/image/fetch/$s_!bcCk!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https://substack-post-media.s3.amazonaws.com/public/images/d6b8c6e7-4e99-4b30-bab2-0b0f738cef47_4396x2548.jpeg)
...
One can calculate the time t this happened, the temperature T at which this happened, and the relative redshift 5.
...
![](https://substackcdn.com/image/fetch/$s_!PSrt!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https://substack-post-media.s3.amazonaws.com/public/images/fe521ab9-c2ff-46c4-9aeb-796b3544fadc_946x710.jpeg)
...
1 With “life of the Universe” we technically mean the time that flows from the start of the metric.
2 Relativistic means that its components have energy almost entirely made out of their momentum and that their mass is negligible.
3 Scattering is when particles (or particles and radiation) interact.
...
5 redshift z is defined in general as the difference between the measured wavelength of the radiation and the emitted wavelength, divided by the emitted wavelength.
